...
We use three datasets for experiments. They are **DBLP, Epinion, Ciao**. The **DBLP** is provided by [Arminer](https://aminer.org/citation) and we use the version V9, **Epinion, Ciao** are by [Jiliang Tang](https://www.cse.msu.edu/~tangjili/trust.html). 
* DBLP:
