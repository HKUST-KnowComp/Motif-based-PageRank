...
def construct_motif(txt_name, times, alpha_value):
    ...
    rresult_B = adjacency_matrix.copy()
    result_B = normal_matrix(result_B)
    # 下面是将7个motif的矩阵进行element-wise的平均之后再进行alpha值的加权融合
    result_M1 = motif_times(adjacency_matrix, times, 'M1')
    result_M2 = motif_times(adjacency_matrix, times, 'M2')
    result_M3 = motif_times(adjacency_matrix, times, 'M3')
    result_M4 = motif_times(adjacency_matrix, times, 'M4')
    result_M5 = motif_times(adjacency_matrix, times, 'M5')
    result_M6 = motif_times(adjacency_matrix, times, 'M6')
    result_M7 = motif_times(adjacency_matrix, times, 'M7')

    result_temp1 = result_B.multiply(alpha_value).tolil()
    result_temp2 = result_M1.multiply(1.0/7.0).tolil()
    result_temp3 = result_M2.multiply(1.0/7.0).tolil()
    result_temp4 = result_M3.multiply(1.0/7.0).tolil()
    result_temp5 = result_M4.multiply(1.0/7.0).tolil()
    result_temp6 = result_M5.multiply(1.0/7.0).tolil()
    result_temp7 = result_M6.multiply(1.0/7.0).tolil()
    result_temp8 = result_M7.multiply(1.0/7.0).tolil()
    result_fusion = result_temp2 + result_temp3
    result_fusion = result_fusion + result_temp4
    result_fusion = result_fusion + result_temp5
    result_fusion = result_fusion + result_temp6
    result_fusion = result_fusion + result_temp7
    result_fusion = result_fusion + result_temp8
    result_fusion = result_fusion.multiply(1-alpha_value)
    result_D = result_temp1 + result_fusion
