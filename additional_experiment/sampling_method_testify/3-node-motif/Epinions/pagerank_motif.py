...
if __name__ == "__main__":
    a, entry_unique = construct_motif('data/Epinions/trust_network_Epinion.txt', 1, '98', 0.4)
    # '98' is the id of one motif which is determined by mfinder software.
