...
if __name__ == "__main__":
    a, entry_unique = construct_motif('data/Epinions/trust_network_Epinion.txt', 1, '8734', 0.4)
    # '8734' is the id of one motif which is determined by mfinder software.
    # you shall use the corresponding id.
